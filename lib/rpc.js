...
class HRPCServiceHypercore {
  constructor (rpc) {
    ...
    this._aquireLock = service.defineMethod({
      id: 11,
  ...
  onRequest (context, handlers = context) {
    ...
    if (handlers.aquireLock) this._aquireLock.onrequest = handlers.aquireLock.bind(context)
  ...
  aquireLock (data) {
    return this._aquireLock.request(data)
  }

  aquireLockNoReply (data) {
    return this._aquireLock.requestNoReply(data)
  }
...
class HRPCServiceNetwork {
  constructor (rpc) {
    ...
    this._getAllNetworkConfigurations = service.defineMethod({
      id: 3,
  ...
  onRequest (context, handlers = context) {
    ...
    if (handlers.getAllNetworkConfigurations) this._getAllNetworkConfigurations.onrequest = handlers.getAllNetworkConfigurations.bind(context)
  ...
  getAllNetworkConfigurations () {
    return this._getAllNetworkConfigurations.request()
  }

  getAllNetworkConfigurationsNoReply () {
    return this._getAllNetworkConfigurations.requestNoReply()
  }
