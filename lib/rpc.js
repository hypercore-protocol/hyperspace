...
const errorEncoding = {
  encode: ErrorMessage.encode,
  encodingLength: ErrorMessage.encodingLength,
  decode (buf, offset) {
    const { message, code, details } = ErrorMessage.decode(buf, offset)
    errorEncoding.decode.bytes = ErrorMessage.decode.bytes
