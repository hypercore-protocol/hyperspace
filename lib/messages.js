...
function definePeer () {
  ...
  function encodingLength (obj) {
    ...
    length += 1 + len
    if (!defined(obj.remoteHost)) throw new Error("remoteHost is required")
    var len = encodings.string.encodingLength(obj.remoteHost)
    length += 1 + len
    return length
  }
  ...
  function encode (obj, buf, offset) {
    ...
    if (!defined(obj.remoteHost)) throw new Error("remoteHost is required")
    buf[offset++] = 26
    encodings.string.encode(obj.remoteHost, buf, offset)
  ...
  function decode (buf, offset, end) {
    ...
    while (true) {
      ...
      switch (tag) {
        ...
        break
        case 3:
        obj.remoteHost = encodings.string.decode(buf, offset)
